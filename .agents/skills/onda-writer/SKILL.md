---
name: onda-writer
description: Redige notícias, novidades, tendências e análises de mercado sob medida para a Onda Conecta com SEO de ponta para ranqueamento no Google, tom dinâmico, estrutura escaneável e call-to-action engajador.
---

# Onda Conecta — Skill de Redação Editorial e SEO (onda-writer)

Esta skill define o tom de voz, as diretrizes editoriais e os critérios de **SEO de alto desempenho** para todos os artigos, reportagens e tendências publicados no portal **Onda Conecta**.
